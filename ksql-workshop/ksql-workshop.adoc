...
2. Checkout the latest stable branch, and change the working directory
+
[source,bash]
----
...
NOTE: On Linux the name of the network is `ksqlworkshop_default` (no `-` between `ksql` and `workshop`).
