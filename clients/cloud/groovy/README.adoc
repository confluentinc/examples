...
NOTE: Produce messages to and consume messages from https://www.confluent.io/confluent-cloud/[Confluent Cloud] using the Groovy version of Java Producer and Consumer, and Kafka Streams API.
