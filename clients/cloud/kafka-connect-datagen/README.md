...
Each record is mock data generated using the [orders schema](https://github.com/confluentinc/kafka-connect-datagen/blob/5.3.1-post/src/main/resources/orders_schema.avro).
