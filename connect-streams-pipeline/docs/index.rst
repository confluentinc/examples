...
.. note:: See this example in the tutorial `Add key to data ingested through Kafka Connect <https://kafka-tutorials.confluent.io/connect-add-key-to-source/kstreams.html>`__.
