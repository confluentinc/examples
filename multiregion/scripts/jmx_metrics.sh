...
do
  ...
  for topic in single-region multi-region-sync multi-region-async multi-region-default under-min-isr-promotion under-replicated-promotion leader-is-observer-promotion
  do
