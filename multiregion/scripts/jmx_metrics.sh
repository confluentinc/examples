...
do
  ...
  do
    ...
    eval docker-compose ps -q broker-west-1 > /dev/null \
    ...
    eval docker-compose ps -q broker-west-2 > /dev/null \
    ...
    eval docker-compose ps -q broker-east-3 > /dev/null \
    ...
    eval docker-compose ps -q broker-east-4 > /dev/null \
