...
The `statements.sql` should match those run in this doc end-to-end and in theory you can just run the file, but I have not tested it. 
...
docker-compose_ksqldb-server_1      /etc/confluent/docker/run        Up      8088/tcp
