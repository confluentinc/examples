...
If you'd like a primer on running |co-long| in GKE with lower resource requirements, see the :ref:`Confluent Platform on Google Kubernetes Engine demo <quickstart-demos-operator-gke>`.
