...
CREATE TABLE CUSTOMERS (ROWKEY INTEGER KEY, id INTEGER, FIRST_NAME VARCHAR, LAST_NAME VARCHAR, EMAIL VARCHAR, GENDER VARCHAR, COMMENTS VARCHAR, MESSAGETOPIC VARCHAR, MESSAGESOURCE VARCHAR) WITH (KAFKA_TOPIC='CUSTOMERS_SRC_REKEY', VALUE_FORMAT ='AVRO', KEY='ID');
