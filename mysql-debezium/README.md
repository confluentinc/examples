...
* Consult [live-coding.adoc](https://github.com/confluentinc/examples/blob/5.3.0-beta190620193213-post/mysql-debezium/live-coding.adoc#show-cdc-in-action) to inspect the topics.
