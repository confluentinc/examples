...
* Consult [live-coding.adoc](https://github.com/confluentinc/examples/blob/5.2.7-post/mysql-debezium/live-coding.adoc#show-cdc-in-action) to inspect the topics.
