...
* Consult [live-coding.adoc](https://github.com/confluentinc/examples/blob/5.4.0-beta190924193216-post/mysql-debezium/live-coding.adoc#show-cdc-in-action) to inspect the topics.
