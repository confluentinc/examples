...
* Consult [live-coding.adoc](https://github.com/confluentinc/examples/blob/5.3.1-beta190720193220-post/mysql-debezium/live-coding.adoc#show-cdc-in-action) to inspect the topics.
