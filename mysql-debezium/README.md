...
* Consult [live-coding.adoc](https://github.com/confluentinc/examples/blob/5.5.0-beta191113041121-post/mysql-debezium/live-coding.adoc#show-cdc-in-action) to inspect the topics.
