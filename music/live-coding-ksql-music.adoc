...
- https://github.com/confluentinc/examples/tree/5.0.1-post/music[automated KSQL demo]
...
NOTE: This tutorial assumes you are running the KSQL music demo application in Docker. You may alternatively run this demo on a Confluent Platform local install just by running the https://github.com/confluentinc/examples/blob/5.0.1-post/music/start.sh[start script].
