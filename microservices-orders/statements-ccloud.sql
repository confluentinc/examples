...
CREATE STREAM orders_enriched AS SELECT customers_table.customerid AS customerid, customers_table.firstname, customers_table.lastname, customers_table.level, orders.product, orders.quantity, orders.price FROM orders LEFT JOIN customers ON orders.customerid = customers.customerid;
