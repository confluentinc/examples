...
The best place to start is [EndToEndTest.java](https://github.com/confluentinc/examples/blob/8.0.5-post/microservices-orders/src/test/java/io/confluent/examples/streams/microservices/EndToEndTest.java)
