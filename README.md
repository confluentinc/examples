...
| [Fully Managed Stack](ccloud/beginner-cloud/README.md#fully-managed-stack-in-confluent-cloud) |  Y  |  N  | Creates a fully-managed stack in Confluent Cloud, including a new environment, service account, Kafka cluster, KSQL app, Schema Registry, and ACLs, plus a local config file <br><img src="clients/cloud/images/confluent-cloud.png" width="300">
