...
| [mysql-debezium](mysql-debezium/README.md) |   Y   |   [Here](https://github.com/confluentinc/demo-scene/tree/master/mysql-debezium-ksql-elasticsearch)    | end-to-end streaming ETL with KSQL for stream processing using the [Debezium Connector for MySQL](http://debezium.io/docs/connectors/mysql/)
