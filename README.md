...
| [GKE to Cloud](kubernetes/replicator-gke-cc/README.md)                 |   [N]   |   [Y](kubernetes/replicator-gke-cc/README.md)    | Uses a Google Kubernetes Engine, [Confluent Cloud](https://www.confluent.io/confluent-cloud/), and [Confluent Replicator](https://www.confluent.io/confluent-replicator/) to explore a multicloud deployment <br><img src="kubernetes/replicator-gke-cc/docs/images/operator-demo-phase-2.png" width="450">
