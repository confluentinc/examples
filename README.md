...
| [100% fully-managed streaming pipeline](kinesis-cloud/README.md)                 |   [Y](kinesis-cloud/README.md)   |   N   | 100% fully-managed streaming pipeline on Confluent Cloud, using Confluent Cloud CLI (Kinesis -> Confluent Cloud -> cloud storage) <br><img src="kinesis-cloud/images/topology.jpg" width="450">
