...
| [100% fully-managed streaming pipeline](kinesis-cloud/README.md)                 |   [Y](kinesis-cloud/README.md)   |   N   | Streaming pipeline and application on Confluent Cloud, using fully-managed Confluent Cloud connectors and fully-managed KSQL (Kinesis -> Confluent Cloud -> cloud storage) <br><img src="kinesis-cloud/images/topology.jpg" width="450">
