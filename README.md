...
| [100% fully-managed streaming pipeline](kinesis-cloud/README.md)                 |   [Y](kinesis-cloud/README.md)   |   N   | 100% fully-managed streaming pipeline on Confluent Cloud, using fully-managed Confluent Cloud connectors and a fully-managed KSQL application (Kinesis -> Confluent Cloud -> cloud storage) <br><img src="kinesis-cloud/images/topology.jpg" width="450">
