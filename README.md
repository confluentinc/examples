...
| [MySQL and Debezium](https://github.com/confluentinc/demo-scene/tree/master/build-a-streaming-pipeline) |   N   |   [Y](https://github.com/confluentinc/demo-scene/tree/master/build-a-streaming-pipeline) | End-to-end streaming ETL with ksqlDB for stream processing using the Debezium Connector for MySQL <br><img src="https://github.com/confluentinc/demo-scene/blob/master/build-a-streaming-pipeline/images/ksql-debezium-es.png?raw=true" width="450">
