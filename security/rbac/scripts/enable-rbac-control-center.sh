...
echo -e "\n# Grant principal User:$USER_CLIENT_C the DeveloperRead role to Topic:$TOPIC1"
echo "confluent iam rbac role-binding create --principal User:$USER_CLIENT_C --role DeveloperRead --resource Topic:$TOPIC1 --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:$USER_CLIENT_C the DeveloperRead role to Topic:$TOPIC2_AVRO"
echo "confluent iam rbac role-binding create --principal User:$USER_CLIENT_C --role DeveloperRead --resource Topic:$TOPIC2_AVRO --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:$USER_CLIENT_C the DeveloperRead role to Subject:${TOPIC2_AVRO}-value"
echo "confluent iam rbac role-binding create --principal User:$USER_CLIENT_C --role DeveloperRead --resource Subject:${TOPIC2_AVRO}-value --kafka-cluster $KAFKA_CLUSTER_ID --schema-registry-cluster $SCHEMA_REGISTRY_CLUSTER_ID"
...
echo -e "\n# Grant principal User:$USER_CLIENT_C the DeveloperRead role to Connector:$CONNECTOR_NAME"
echo "confluent iam rbac role-binding create --principal User:$USER_CLIENT_C --role DeveloperRead --resource Connector:$CONNECTOR_NAME --kafka-cluster $KAFKA_CLUSTER_ID --connect-cluster $CONNECT_CLUSTER_ID"
