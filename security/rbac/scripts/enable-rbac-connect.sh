...
echo -e "\n# List the role bindings for User:$ADMIN_CONNECT to the Kafka cluster"
...
echo -e "Sleeping 25 seconds before getting the Connect cluster ID"
sleep 25
...
echo -e "\n# List the role bindings for the principal User:$ADMIN_CONNECT to the Connect cluster"
...
echo -e "\n# List the role bindings for the principal User:$CLIENT to the Connect cluster"
