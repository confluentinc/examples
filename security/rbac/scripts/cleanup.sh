...
for propfile in $CONFLUENT_HOME/etc/kafka/server.properties $CONFLUENT_HOME/etc/schema-registry/connect-avro-distributed.properties $CONFLUENT_HOME/etc/confluent-control-center/control-center-dev.properties $CONFLUENT_HOME/etc/ksql/ksql-server.properties $CONFLUENT_HOME/etc/kafka-rest/kafka-rest.properties $CONFLUENT_HOME/etc/schema-registry/schema-registry.properties; do
