...
echo -e "\n# Grant principal User:$USER_ADMIN_KSQLDB the ResourceOwner role to Topic:_confluent-ksql-${KSQL_SERVICE_ID}_command_topic"
echo "confluent iam rbac role-binding create --principal User:$USER_ADMIN_KSQLDB --role ResourceOwner --resource Topic:_confluent-ksql-${KSQL_SERVICE_ID}_command_topic --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo "confluent iam rbac role-binding create --principal User:$USER_ADMIN_KSQLDB --role ResourceOwner --resource Topic:${KSQL_SERVICE_ID}ksql_processing_log --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo "confluent iam rbac role-binding create --principal User:$USER_ADMIN_KSQLDB --role SecurityAdmin --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID"
...
echo -e "\n# Grant principal User:$USER_ADMIN_KSQLDB the ResourceOwner role to KsqlCluster:ksql-cluster"
echo "confluent iam rbac role-binding create --principal User:$USER_ADMIN_KSQLDB --role ResourceOwner --resource KsqlCluster:ksql-cluster --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID"
...
echo "confluent iam rbac role-binding list --principal User:$USER_ADMIN_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding list --principal User:$USER_ADMIN_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# List the role bindings for the principal User:$USER_ADMIN_KSQLDB to the ksqlDB cluster"
echo "confluent iam rbac role-binding list --principal User:$USER_ADMIN_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID"
confluent iam rbac role-binding list --principal User:$USER_ADMIN_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID


##################################################
# KSQL client functions
# Note: KSQL server executes many of the commands that the KSQL client issues
# - Grant principal User:${USER_KSQLDB} the ResourceOwner role to KsqlCluster:ksql-cluster
# - Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:$TOPIC1
# - Grant principal User:${USER_KSQLDB} the ResourceOwner role to Group:_confluent-ksql-${KSQL_SERVICE_ID} prefix
# - Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:${KSQL_SERVICE_ID}ksql_processing_log
# - Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Group:_confluent-ksql-${KSQL_SERVICE_ID} prefix"
# - Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:$TOPIC1"
...
echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to KsqlCluster:ksql-cluster"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource KsqlCluster:ksql-cluster --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID"
confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource KsqlCluster:ksql-cluster --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID

echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:$TOPIC1"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:$TOPIC1 --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:$TOPIC1 --kafka-cluster $KAFKA_CLUSTER_ID
...
echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Group:_confluent-ksql-${KSQL_SERVICE_ID} prefix"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Group:_confluent-ksql-${KSQL_SERVICE_ID} --prefix --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Group:_confluent-ksql-${KSQL_SERVICE_ID} --prefix --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:${KSQL_SERVICE_ID}ksql_processing_log"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:${KSQL_SERVICE_ID}ksql_processing_log --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:${KSQL_SERVICE_ID}ksql_processing_log --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Group:_confluent-ksql-${KSQL_SERVICE_ID} prefix"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Group:_confluent-ksql-${KSQL_SERVICE_ID} --prefix --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Group:_confluent-ksql-${KSQL_SERVICE_ID} --prefix --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:$TOPIC1"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:$TOPIC1 --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:$TOPIC1 --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to TransactionalId:${KSQL_SERVICE_ID}"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource TransactionalId:${KSQL_SERVICE_ID} --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:${KSQL_SERVICE_ID}transient prefix"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:_confluent-ksql-${KSQL_SERVICE_ID}transient --prefix --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:${KSQL_SERVICE_ID}transient prefix"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:_confluent-ksql-${KSQL_SERVICE_ID}transient --prefix --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:${CSAS_STREAM1}"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:${CSAS_STREAM1} --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:${CSAS_STREAM1}"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:${CSAS_STREAM1} --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_KSQLDB} the ResourceOwner role to Topic:${CTAS_TABLE1}"
echo "confluent iam rbac role-binding create --principal User:${USER_KSQLDB} --role ResourceOwner --resource Topic:${CTAS_TABLE1} --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:${CTAS_TABLE1}"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:${CTAS_TABLE1} --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# Grant principal User:${USER_ADMIN_KSQLDB} the ResourceOwner role to Topic:_confluent-ksql-${KSQL_SERVICE_ID} prefix"
echo "confluent iam rbac role-binding create --principal User:${USER_ADMIN_KSQLDB} --role ResourceOwner --resource Topic:_confluent-ksql-${KSQL_SERVICE_ID} --prefix --kafka-cluster $KAFKA_CLUSTER_ID"
...
echo -e "\n# List the role bindings for the principal User:$USER_KSQLDB"
echo "confluent iam rbac role-binding list --principal User:$USER_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID"
confluent iam rbac role-binding list --principal User:$USER_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID

echo -e "\n# List the role bindings for the principal User:$USER_KSQLDB to the ksqlDB cluster"
echo "confluent iam rbac role-binding list --principal User:$USER_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID"
confluent iam rbac role-binding list --principal User:$USER_KSQLDB --kafka-cluster $KAFKA_CLUSTER_ID --ksql-cluster $KSQL_SERVICE_ID
